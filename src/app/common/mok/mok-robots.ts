...
export const robots: Robot[] = [
    new Robot(6, 'ema teler', 'https://static3.depositphotos.com/1003034/155/i/950/depositphotos_1559329-stock-photo-funny-robot-stay-and-show.jpg', 'femme', 19, 'fan de tv et de film j\'aime le drama ', defaultPlanetes.filter((x) => x.name === 'Mercure')[0]),
